...
func _ready():
	...
	waves = [
		...
		},
		{
			...
			"mob_health": { preload("res://scenes/Crow.tscn"): 40 },
			"spawn_interval": 0.5,
			"max_wave_mobs": 400,
			"max_mobs": 600,
			"duration": 60
		},
		{
			...
			"mob_health": { preload("res://scenes/Orc.tscn"): 60 },
			"spawn_interval": 0.5,
			"max_wave_mobs": 400,
			"max_mobs": 600,
			"duration": 60
		},
		{
			...
			"mob_health": { preload("res://scenes/Necromancer.tscn"): 100 },
			"spawn_interval": 1,
			"max_wave_mobs": 300,
			"max_mobs": 600,
			"duration": 60
		...
		},
		{
			...
			"mob_health": { preload("res://scenes/Skeleton.tscn"): 80 },
			"spawn_interval": 0.3,
			"max_wave_mobs": 300,
			"max_mobs": 600,
			"duration": 60
		...
		{
			"mobs": [preload("res://scenes/Crow.tscn")],
			"mob_health": { preload("res://scenes/Crow.tscn"): 30 },
			"spawn_interval": 0.6,
			"max_wave_mobs": 400,
			"max_mobs": 600,
			"duration": 60
		},
		{
			...
			"mob_health": { preload("res://scenes/Mushroom.tscn"): 130 },
			"spawn_interval": 0.4,
			"max_wave_mobs": 500,
			"max_mobs": 600,
			"duration": 60
		...
		{
			"mobs": [preload("res://scenes/Orc.tscn")],
			"mob_health": { preload("res://scenes/Orc.tscn"): 50 },
			"spawn_interval": 0.6,
			"max_wave_mobs": 400,
			"max_mobs": 600,
			"duration": 60
		},
		{
			...
			"mob_health": { preload("res://scenes/OldGuardian.tscn"): 300 },
			"spawn_interval": 0.5,
			"max_wave_mobs": 120,
			"max_mobs": 600,
			"duration": 60
